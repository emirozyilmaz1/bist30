...
/* Slider tooltip ve value box */
[data-baseweb="tooltip"] {
    background: #2563EB !important;
}
div[data-testid="stSlider"] div[data-baseweb="popover"] div {
    background: #2563EB !important;
    color: #FFFFFF !important;
...
if run_btn:
    ...
    st.markdown("---")
    st.info("👈 Sol panelden başlayın — hisse kodunu girin ve **Analizi Çalıştır** butonuna basın.")    background: #2563EB !important;
    color: #FFFFFF !important;
    border: none !important;
    border-radius: 8px !important;
    font-weight: 600 !important;
